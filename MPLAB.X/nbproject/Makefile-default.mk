...
SOURCEFILES_QUOTED_IF_SPACED=ADC_Library.c INTERRUPT_Library.c POSTLAB_01.c TMR_Library.c FourDISP_Library.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ADC_Library.p1 ${OBJECTDIR}/INTERRUPT_Library.p1 ${OBJECTDIR}/POSTLAB_01.p1 ${OBJECTDIR}/TMR_Library.p1 ${OBJECTDIR}/FourDISP_Library.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ADC_Library.p1.d ${OBJECTDIR}/INTERRUPT_Library.p1.d ${OBJECTDIR}/POSTLAB_01.p1.d ${OBJECTDIR}/TMR_Library.p1.d ${OBJECTDIR}/FourDISP_Library.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ADC_Library.p1 ${OBJECTDIR}/INTERRUPT_Library.p1 ${OBJECTDIR}/POSTLAB_01.p1 ${OBJECTDIR}/TMR_Library.p1 ${OBJECTDIR}/FourDISP_Library.p1

# Source Files
SOURCEFILES=ADC_Library.c INTERRUPT_Library.c POSTLAB_01.c TMR_Library.c FourDISP_Library.c
...
${OBJECTDIR}/POSTLAB_01.p1: POSTLAB_01.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/POSTLAB_01.p1.d 
	@${RM} ${OBJECTDIR}/POSTLAB_01.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/POSTLAB_01.p1 POSTLAB_01.c 
	@-${MV} ${OBJECTDIR}/POSTLAB_01.d ${OBJECTDIR}/POSTLAB_01.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/POSTLAB_01.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
